...
export default function Resources({ pdfs = [] }) {
  ...
  const handleCardClick = (pdfFile) => {
    setSelectedPdf(`/resources/${pdfFile}`)
  ...
  return (
    <div className="h-full overflow-auto p-4">
      <h2 className="text-xl font-semibold mb-4">Choose your resource</h2>
