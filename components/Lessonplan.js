...
export default function LessonPlan() {
  ...
  return (
    <div className="min-h-screen bg-[#141333] text-white p-4 sm:p-8">
      <h1 className="text-3xl sm:text-4xl font-bold mb-6 text-center">Lesson Plan</h1>

      {loading && (
        <div className="text-center text-lg">Loading lesson plan...</div>
      )}
      ...
      {!loading && !error && data.length === 0 && (
        <div className="text-center text-lg">No lesson plan data available.</div>
      )}
    </div>
  )
}
